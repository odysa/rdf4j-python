...
class TestSyncApiClientInitialization:
    ...
    def test_client_attribute_available_after_init(self):
        ...
        assert hasattr(client, 'client'), "client attribute should be available after __init__"
        assert client.client is not None, "client should not be None after __init__"
        
        # The client should be an httpx.Client instance
        assert isinstance(client.client, httpx.Client), "client should be httpx.Client instance"
...
class TestAsyncApiClientInitialization:
    ...
    def test_client_attribute_available_after_init(self):
        ...
        assert isinstance(client.client, httpx.AsyncClient), "client should be httpx.AsyncClient instance"
